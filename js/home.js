  ...
  fetch("http://oreumi.appspot.com/video/getVideoList")
    ...
    .then((data) => {
      ...
      for (let i = 0; i < data.length; i++) {
        ...
        //video.html, video.js - video id index sending
        //channel.html, channel.js - video channel index sending
      ...
      //searchParam - searchInput param input
      let searchParam = url.searchParams.get("searchInput"); //video primary number
...
// searchInput param using
function fn_search(param) {

  var searchInput = document.getElementById('searchInput');
  var searchValue = document.getElementById('searchInput').value;
  //if searchInput has value
  if (param != null) {
    searchValue = param;
    //searchInput - setting
